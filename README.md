...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="./Ex9_DashboardMaterial/KetQua2.PNG" alt="Ex7_IntentLogin1" width="15%"/>
  <img src="./Ex9_DashboardMaterial/KetQua1.PNG" alt="Ex7_IntentLogin2" width="15%"/>
</div>
